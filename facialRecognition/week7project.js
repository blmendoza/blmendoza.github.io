...
function draw() {
    ...
    image(capture, 0, 0, w, h); //video on canvas, position, dimensions
    ...
    textSize(32);
    if (finalScoreText==false){
      text(score, 10, 30);
    }
    else if (finalScoreText==true){
      text("Game over. Your final score is: " + score + ".", 10, 50);
    }
    ...
    if (positions.length > 0) {
      ...
      if(gate1==true){ //1
        ...
        pos1+=speed;
        if(int(dist(xPos1, pos1, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateA==true){ //A
        ...
        posA+=speed;
        if(int(dist(xPosA, posA, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate2==true){ //2
        ...
        pos2+=speed;
        if(int(dist(xPos2, pos2, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateB==true){ //B
        ...
        posB+=speed;
        if(int(dist(xPosB, posB, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate3==true){ //3
        ...
        pos3+=speed;
        if(int(dist(xPos3, pos3, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateC==true){ //C
        ...
        posC+=speed;
        if(int(dist(xPosC, posC, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate4==true){ //4
        ...
        pos4+=speed;
        if(int(dist(xPos4, pos4, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateD==true){ //D
        ...
        posD+=speed;
        if(int(dist(xPosD, posD, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate5==true){ //5
        ...
        pos5+=speed;
        if(int(dist(xPos5, pos5, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateE==true){ //E
        ...
        posE+=speed;
        if(int(dist(xPosE, posE, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate6==true){ //6
        ...
        pos6+=speed;
        if(int(dist(xPos6, pos6, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateF==true){ //F
        ...
        posF+=speed;
        if(int(dist(xPosF, posF, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate7==true){ //7
        ...
        pos7+=speed;
        if(int(dist(xPos7, pos7, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateG==true){ //G
        ...
        posG+=speed;
        if(int(dist(xPosG, posG, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate8==true){ //8
        ...
        pos8+=speed;
        if(int(dist(xPos8, pos8, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateH==true){ //H
        ...
        posH+=speed;
        if(int(dist(xPosH, posH, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate9==true){ //9
        ...
        pos9+=speed;
        if(int(dist(xPos9, pos9, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateI==true){ //I
        ...
        posI+=speed;
        if(int(dist(xPosI, posI, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate10==true){ //10
        ...
        pos10+=speed;
        if(int(dist(xPos10, pos10, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateJ==true){ //J
        ...
        posJ+=speed;
        if(int(dist(xPosJ, posJ, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate11==true){ //11
        ...
        pos11+=speed;
        if(int(dist(xPos11, pos11, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateK==true){ //K
        ...
        posK+=speed;
        if(int(dist(xPosK, posK, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate12==true){ //12
        ...
        pos12+=speed;
        if(int(dist(xPos12, pos12, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateL==true){ //L
        ...
        posL+=speed;
        if(int(dist(xPosL, posL, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate13==true){ //13
        ...
        pos13+=speed;
        if(int(dist(xPos13, pos13, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateM==true){ //M
        ...
        posM+=speed;
        if(int(dist(xPosM, posM, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate14==true){ //14
        ...
        pos14+=speed;
        if(int(dist(xPos14, pos14, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateN==true){ //N
        ...
        posN+=speed;
        if(int(dist(xPosN, posN, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
      ...
      if(gate15==true){ //15
        ...
        pos15+=speed;
        if(int(dist(xPos15, pos15, positions[60][0], positions[60][1])) < radius){
          score++;
        }
      }
      ...
      if(gateO==true){ //O
        ...
        posO+=speed;
        if(int(dist(xPosO, posO, positions[60][0], positions[60][1])) < radius){
          score--;
        }
      }
    }
